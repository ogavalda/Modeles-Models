...
# start the measure
class SetNISTInfiltrationCorrelations1980 < OpenStudio::Measure::ModelMeasure
  # human readable name
  def name
    return "SetNISTInfiltrationCorrelations 1980"
  end
...
SetNISTInfiltrationCorrelations1980.new.registerWithApplication
